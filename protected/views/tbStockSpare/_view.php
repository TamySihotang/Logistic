...
/* @var $data TbStockSpare */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('id_stock_spare')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->id_stock_spare), array('view', 'id'=>$data->id_stock_spare)); ?>
	<br />
