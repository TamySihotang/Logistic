        ...
        'items' => array(
            array(
                ...
                'items' => array(
                    ...
                    array('label' => 'Register Office', 'url' => 'index.php?r=tbAuthorBranchOffice/Registration','visible'=> !Yii::app()->user->isGuest),
                    array('label' => 'Spare', 'url' => 'index.php?r=tbSnSpare/viewSpare'),
                    array('label' => 'Request', 'url' => 'index.php?r=tbSnSpare/request','visible'=>!Yii::app()->user->isGuest),
                    array(
                        'label' => 'Inventory','visible'=>!Yii::app()->user->isGuest,
                        'url' => '#',
                        'items' => array(
                            array('label' => 'Sparepart', 'url' => 'index.php?r=tbSnSpare/viewSpare'),
                            array('label' => 'Availability', 'url' => 'index.php?r=tbSnSpare/viewSummary1'),
                        )
                    ),
                    array(
                        ...
                        'url' => '#',
                        'items' => array(
                            array('label' => 'My Request', 'url' => '#'),
                            array('label' => 'Request For Me', 'url' => '#'),
                        )
                    ),
                ),
            ),
